...
function customEvery(arr, condition) {
  ...
  if (!Array.isArray(arr)) {
    console.log("Помилка: Вхідний параметр arr має бути масивом.");
    return false;
  }

  if (typeof condition !== "function") {
    console.log("Помилка: Вхідний параметр condition має бути функцією.");
    return false;
  }
...
function customFill(arr, value, start = 0, end = arr.length) {
  ...
  if (start < 0 || start > arr.length || end < 0 || end > arr.length) {
    console.log(
      "Помилка: Початковий та кінцевий індекс мають бути в межах довжини масиву."
    );
    return false;
  }
